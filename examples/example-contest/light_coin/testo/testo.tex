...
\[
    \mbox{\textrm{piatto\_con\_peso\_maggiore()}}\, =
    \left\{
       \begin{array}{ll}
          \textrm{NONE} & \mbox{se i due piatti della bilancia sono in perfetto equilibrio;}\\
          \textrm{LEFT} & \mbox{se il carico \`e maggiore sul piatto sinistro;}\\
          \textrm{RIGHT} & \mbox{se il carico \`e maggiore sul piatto destro.}\\
       \end{array}
    \right.
\]
